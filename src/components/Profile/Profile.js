      ...
      <div className='profile__container'>
        ...
        <form className='profile__form'>
          <div className='form__input-container'>
            ...
            <input className='form__profile-input' name="name" type="text" id="inputName" required minLength="2" maxLength="30"></input>
          </div>
          <div className='form__input-container form__input-container_type_email'>
            <legend className='form__profile-title'>E-mail</legend>
            <input className='form__profile-input' name="email" type="email" id="inputEmail" required minLength="2" maxLength="30"></input>
          </div>
          ...
          <Link to="/sign-in" className='form__profile-link'>Выйти из аккаунта </Link>
        </form>
      </div>
  </main>
  )
